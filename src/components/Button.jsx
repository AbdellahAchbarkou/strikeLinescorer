...
const Button = ({ children, variant = 'primary', size = 'md', className = '', onClick, ...props }) => {
  ...
  const variants = {
    primary: 'bg-cyan-600 hover:bg-cyan-700 text-white focus:ring-cyan-500 shadow-lg hover:shadow-xl',
    secondary: 'bg-slate-700 hover:bg-slate-600 text-white focus:ring-slate-500 border border-slate-600',
    outline: 'border-2 border-cyan-600 text-cyan-400 hover:bg-cyan-600 hover:text-white focus:ring-cyan-500',
    ghost: 'text-gray-300 hover:text-white hover:bg-slate-700 focus:ring-slate-500'
  };
